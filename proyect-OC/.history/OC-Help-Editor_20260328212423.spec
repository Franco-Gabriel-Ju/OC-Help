...
tcl_root = 'C:/Users/Alexxe/AppData/Local/Programs/Python/Python313/tcl'
os.environ.setdefault('TCL_LIBRARY', f'{tcl_root}/tcl8.6')
os.environ.setdefault('TK_LIBRARY', f'{tcl_root}/tk8.6')
