    ...
    def __init__(self, root):
        ...
        class CalculadoraConversorApp:
            ...
            def _build_ui(self):
                ...
                control_bar.grid_columnconfigure(6, weight=1)

                tk.Label(control_bar, text="Base entrada", bg="#111820", fg="#bdd0e7", font=("Segoe UI", 10, "bold")).grid(row=0, column=0, padx=(0, 8))
                col = 1
                for key in ("DEC", "BIN", "HEX", "OCT"):
                    rb = tk.Radiobutton(
                        ...
                        text=key,
                        value=key,
                        variable=self.base_activa_var,
                        indicatoron=False,
                        bg="#2d394a",
                        fg="#ecf5ff",
                        selectcolor="#5e3f74",
                        activebackground="#3b4b5f",
                    ...
                    rb.grid(row=0, column=col, padx=3)
                    col += 1

                tk.Label(control_bar, text="Precision", bg="#111820", fg="#bdd0e7").grid(row=0, column=5, padx=(14, 6))
                tk.Spinbox(
                    control_bar,
                    from_=0,
                    to=16,
                ...
                tk.Label(control_bar, text="Sep.", bg="#111820", fg="#bdd0e7").grid(row=0, column=7, padx=(14, 6))
                ttk.Combobox(control_bar, textvariable=self.separador_var, values=[",", "."], state="readonly", width=3).grid(row=0, column=8)
                ...
                tk.Label(input_frame, text="Entrada", bg="#182330", fg="#9ec0df", font=("Segoe UI", 11, "bold")).grid(row=0, column=0, padx=10, pady=8)
            ...
            def _refresh_digit_buttons(self):
                ...
                permitidos = "01" if base == 2 else "01234567" if base == 8 else "0123456789" if base == 10 else "0123456789ABCDEF"
