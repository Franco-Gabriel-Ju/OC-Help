    ...
    def _sumar_nc(self):
        try:
            ...
            if not operando1 or not operando2:
                self.estado_var.set("Llena ambos operandos antes de sumar.")
                return

            resultado_nc, resultado_explicito = sumar_nc(
                operando1,
                operando2,
            ...
            self.estado_var.set(f"Error en suma NC: {exc}")
            return

        self.suma_resultado_var.set(resultado_nc)
        self.suma_resultado_explicito_var.set(resultado_explicito)
        self.estado_var.set("Suma NC calculada.")
