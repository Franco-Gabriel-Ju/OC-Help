...
class CalculadoraConversorApp:
    ...
    def _build_ui(self):
        ...
        input_frame.grid(row=2, column=0, sticky="ew", pady=(0, 14))
        input_frame.grid_columnconfigure(1, weight=1)
        input_frame.grid_columnconfigure(3, weight=0)

        tk.Label(input_frame, text="Entrada", bg="#182330", fg="#9ec0df", font=("Segoe UI", 13, "bold")).grid(
        ...
        tk.Label(input_frame, text="Base", bg="#182330", fg="#9ec0df", font=("Segoe UI", 12, "bold")).grid(
        ...
        center.grid_columnconfigure(0, weight=6)
        center.grid_columnconfigure(1, weight=5)
