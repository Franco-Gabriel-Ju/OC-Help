...
class CalculadoraConversorApp:
    ...
    def __init__(self, root):
        ...
        self.mostrar_nc2nc_var = tk.BooleanVar(value=True)
    ...
    def _build_ui(self):
        main = tk.Frame(self.root, bg="#111820", padx=12, pady=10)
        ...
        subtitle.grid(row=0, column=0, sticky="e", pady=(0, 8))
        ...
        tk.Label(control_bar, text="Fracciones", bg="#111820", fg="#bdd0e7").grid(row=0, column=1, padx=(0, 6), sticky="w")
        ...
        tk.Label(control_bar, text="Sep.", bg="#111820", fg="#bdd0e7").grid(row=0, column=3, padx=(14, 6))
        ...
        tk.Label(control_bar, text="B", bg="#111820", fg="#bdd0e7").grid(row=0, column=7, padx=(8, 4))
        ...
        tk.Label(control_bar, text="E", bg="#111820", fg="#bdd0e7").grid(row=0, column=9, padx=(8, 4))
        ...
        tk.Label(control_bar, text="F", bg="#111820", fg="#bdd0e7").grid(row=0, column=11, padx=(8, 4))
        ...
        tk.Checkbutton(
            control_bar,
            text="Mostrar NC->NC",
            variable=self.mostrar_nc2nc_var,
            command=self._toggle_nc2nc_panel,
            bg="#111820",
            fg="#ecf5ff",
            activebackground="#111820",
            activeforeground="#ecf5ff",
            selectcolor="#1c2a38",
            font=("Segoe UI", 10, "bold"),
        ).grid(row=0, column=14, padx=(14, 0))
        ...
        for key in ("DEC", "BIN", "HEX", "OCT"):
            ...
            entry.grid(row=row, column=1, sticky="nsew", padx=(4, 4), pady=2, ipady=5)
        ...
        for r, row_keys in enumerate(keys):
            for c, key in enumerate(row_keys):
                btn = tk.Button(
                    ...
                    relief="flat",
                    bd=0,
                    font=("Segoe UI", 12, "bold") if len(key) <= 2 else ("Segoe UI", 10, "bold"),
                )
                btn.grid(row=r, column=c, sticky="nsew", padx=2, pady=2)
                if key in "0123456789ABCDEF":
                    self._digit_buttons[key] = btn

        abreviacion_lbl = tk.Label(
            main,
        ...
        abreviacion_lbl.grid(row=4, column=0, sticky="ew", pady=(8, 0))

        self.nc2nc_frame = tk.Frame(main, bg="#162433", bd=0, highlightthickness=1, highlightbackground="#2c4058", padx=8, pady=8)
        self.nc2nc_frame.grid(row=5, column=0, sticky="ew", pady=(8, 0))
        ...
        if not self.mostrar_nc2nc_var.get():
