...
class CalculadoraConversorApp:
    ...
    def _build_ui(self):
        ...
        nc2nc_frame = tk.Frame(main, bg="#162433", bd=0, highlightthickness=1, highlightbackground="#2c4058", padx=8, pady=8)
        nc2nc_frame.grid(row=5, column=0, sticky="ew", pady=(8, 0))
        nc2nc_frame.grid_columnconfigure(11, weight=1)
        ...
        tk.Label(nc2nc_frame, text="Entrada comp.", bg="#162433", fg="#b8cde2").grid(row=1, column=0, padx=(0, 6), sticky="w")
        tk.Entry(
            nc2nc_frame,
        ...
        tk.Label(nc2nc_frame, text="Origen", bg="#162433", fg="#b8cde2").grid(row=1, column=2, padx=(0, 4), sticky="w")
        ttk.Combobox(nc2nc_frame, textvariable=self.nc2nc_origen_base_var, values=("DEC", "BIN", "HEX", "OCT"), state="readonly", width=5).grid(row=1, column=3, sticky="w")
        tk.Label(nc2nc_frame, text="E", bg="#162433", fg="#b8cde2").grid(row=1, column=4, padx=(8, 2), sticky="w")
        tk.Spinbox(nc2nc_frame, from_=1, to=32, width=3, textvariable=self.nc2nc_origen_e_var, justify="center").grid(row=1, column=5, sticky="w")
        tk.Label(nc2nc_frame, text="F", bg="#162433", fg="#b8cde2").grid(row=1, column=6, padx=(8, 2), sticky="w")
        tk.Spinbox(nc2nc_frame, from_=0, to=16, width=3, textvariable=self.nc2nc_origen_f_var, justify="center").grid(row=1, column=7, sticky="w")

        tk.Label(nc2nc_frame, text="Destino", bg="#162433", fg="#b8cde2").grid(row=1, column=8, padx=(10, 4), sticky="w")
        ttk.Combobox(nc2nc_frame, textvariable=self.nc2nc_dest_base_var, values=("DEC", "BIN", "HEX", "OCT"), state="readonly", width=5).grid(row=1, column=9, sticky="w")
        tk.Label(nc2nc_frame, text="E", bg="#162433", fg="#b8cde2").grid(row=1, column=10, padx=(8, 2), sticky="w")
        tk.Spinbox(nc2nc_frame, from_=1, to=32, width=3, textvariable=self.nc2nc_dest_e_var, justify="center").grid(row=1, column=11, sticky="w")
        tk.Label(nc2nc_frame, text="F", bg="#162433", fg="#b8cde2").grid(row=1, column=12, padx=(8, 2), sticky="w")
        tk.Spinbox(nc2nc_frame, from_=0, to=16, width=3, textvariable=self.nc2nc_dest_f_var, justify="center").grid(row=1, column=13, sticky="w")
        ...
        tk.Label(nc2nc_frame, text="Resultado", bg="#162433", fg="#b8cde2").grid(row=2, column=6, padx=(10, 6), pady=(8, 0), sticky="w")
        tk.Entry(
            nc2nc_frame,
