...
class CalculadoraConversorApp:
    ...
    def _build_ui(self):
        ...
        tk.Label(control_bar, text="E", bg="#111820", fg="#bdd0e7").grid(row=0, column=7, padx=(8, 4))
        ...
        self.nc_enteras_spin.grid(row=0, column=8, sticky="w")

        tk.Label(control_bar, text="F", bg="#111820", fg="#bdd0e7").grid(row=0, column=9, padx=(8, 4))
        ...
        self.nc_fracc_spin.grid(row=0, column=10, sticky="w")
        ...
        tk.Checkbutton(
            ...
            selectcolor="#1c2a38",
            font=("Segoe UI", 10, "bold"),
        ).grid(row=0, column=11, padx=(14, 0))
        ...
        try:
            ...
            for key, base_dest in self.BASES.items():
                ...
                salida = convertir(
                    ...
                    separador=separador,
                    enteros_valor_fijos=(enteros_fijos - 1) if enteros_fijos is not None and complemento else None,
                )
