...
def _manual_conversion_target_data(numero, base_origen, base_dest, separador, resultado):
    data = {
...
def api_manual_target():
    ...
    try:
        ...
        detalle_data = _manual_conversion_target_data(numero, base_origen, base_dest, separador, resultado)
