...
class CalculadoraConversorApp:
    ...
    def _generar_pasos_conversor(self):
        ...
        try:
            if entrada_ya_comp:
                detalle.append("")
                detalle.append("1) La entrada ya esta complementada, entonces primero se descomplementa:")
                detalle.append("   Regla: si bit/digito de signo es 1, se aplica la inversa de Cn para recuperar el valor explicito.")
                numero_trabajo = descomplementar(
                    numero_trabajo,
                    base_origen,
                    separador=separador,
                ...
                detalle.append(f"   Valor explicito obtenido: {numero_trabajo}")
                complemento = None
            else:
                detalle.append("")
            ...
            if self.redondear_var.get():
                ...
                detalle.append("")
                detalle.append("2) Precision de trabajo:")
                ...
                detalle.append("")
                detalle.append("2) Redondeo desactivado, se usa precision alta de trabajo.")
                detalle.append(f"   precision_objetivo={precision_obj}")
            ...
            detalle.append("")
            detalle.append("3) Conversion al destino:")
            ...
            detalle.append("")
            detalle.append("4) Resultado final:")
