...
class CalculadoraConversorApp:
    ...
    def _actualizar_resumen(self):
        ...
        comp_texto = "sin complemento" if comp == "ninguno" else "con complemento"
    ...
    def convertir(self):
        try:
            complemento = None if self.complemento_var.get() == "ninguno" else "complemento"
            resultado = convertir(
                self.numero_var.get(),
